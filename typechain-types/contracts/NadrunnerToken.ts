...
export interface NadrunnerTokenInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "MAX_GAME_MINT"
      | "allowance"
  ...
  encodeFunctionData(
    functionFragment: "MAX_GAME_MINT",
    values?: undefined
  ): string;
  encodeFunctionData(
  ...
  encodeFunctionData(
    functionFragment: "mintGameScore",
...
export interface NadrunnerToken extends BaseContract {
  connect(runner?: ContractRunner | null): NadrunnerToken;
  waitForDeployment(): Promise<this>;

  interface: NadrunnerTokenInterface;
  ...
  MAX_GAME_MINT: TypedContractMethod<[], [bigint], "view">;
  ...
  mintGameScore: TypedContractMethod<
    [score: BigNumberish, signature: BytesLike],
    [void],
    "nonpayable"
  >;
