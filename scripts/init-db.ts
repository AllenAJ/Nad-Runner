...
async function initializeDatabase() {
    ...
    try {
        ...
        await client.query(`
            ...
            VALUES 
                ('haha', 'Haha Mouth', 'A cheerful laughing mouth', 'outfits', 'mouth', 'premium', 1000, '/items/Mouth/Haha.png', '/items/Mouth/Haha.svg'),
                ('smileysnug', 'Smiley Snug', 'A warm and cozy smile', 'outfits', 'mouth', 'premium', 1200, '/items/Mouth/SmileySnug.png', '/items/Mouth/SmileySnug.svg'),
                ('pout', 'Pout', 'A cute pouty expression', 'outfits', 'mouth', 'rare', 1500, '/items/Mouth/Pout.png', '/items/Mouth/Pout.svg'),
                ('tinytooth', 'Tiny Tooth', 'An adorable tiny tooth smile', 'outfits', 'mouth', 'normal', 800, '/items/Mouth/TinyTooth.png', '/items/Mouth/TinyTooth.svg'),
                ('chomp', 'Chomp', 'A playful chomping expression', 'outfits', 'mouth', 'ultra_rare', 2000, '/items/Mouth/Chomp.png', '/items/Mouth/Chomp.svg'),
                ('swag', 'Swag Eyes', 'Cool and stylish eyes', 'outfits', 'eyes', 'rare', 1200, '/items/Eyes/Swag.png', '/items/Eyes/Swag.svg'),
                ('coolglass', 'Cool Glass', 'Trendy sunglasses for a cool look', 'outfits', 'eyes', 'premium', 1500, '/items/Eyes/CoolGlass.png', '/items/Eyes/CoolGlass.svg'),
                ('grumpy', 'Grumpy Eyes', 'Adorably grumpy expression', 'outfits', 'eyes', 'rare', 1300, '/items/Eyes/Grumpy.png', '/items/Eyes/Grumpy.svg'),
                ('sparklyeyes', 'Sparkly Eyes', 'Eyes that twinkle with joy', 'outfits', 'eyes', 'ultra_rare', 2200, '/items/Eyes/SparklyEyes.png', '/items/Eyes/SparklyEyes.svg'),
                ('dizzy', 'Dizzy Eyes', 'Spinning stars in your eyes', 'outfits', 'eyes', 'premium', 1400, '/items/Eyes/dizzy.png', '/items/Eyes/dizzy.svg'),
                ('huh', 'Huh Eyes', 'A confused and curious expression', 'outfits', 'eyes', 'normal', 800, '/items/Eyes/Huh.png', '/items/Eyes/Huh.svg'),
                ('bored', 'Bored Eyes', 'An unimpressed expression', 'outfits', 'eyes', 'normal', 700, '/items/Eyes/Bored.png', '/items/Eyes/Bored.svg'),
                ('innocent', 'Innocent Eyes', 'Pure and innocent looking eyes', 'outfits', 'eyes', 'rare', 1600, '/items/Eyes/Innocent.png', '/items/Eyes/Innocent.svg'),
                ('musketeer', 'Musketeer Hat', 'A dashing hat worn by brave musketeers', 'outfits', 'head', 'rare', 1500, '/items/Head/Musketeer.png', '/items/Head/Musketeer.svg'),
                ('bandage', 'Bandage', 'A simple bandage wrap for your head', 'outfits', 'head', 'normal', 500, '/items/Head/Bandage.png', '/items/Head/Bandage.svg'),
                ('brown_hat', 'Brown Hat', 'A stylish brown hat for casual wear', 'outfits', 'head', 'normal', 800, '/items/Head/Brown_hat.png', '/items/Head/Brown_hat.svg'),
                ('halo', 'Halo', 'A divine halo that glows above your head', 'outfits', 'head', 'ultra_rare', 2500, '/items/Head/Halo.png', '/items/Head/Halo.svg'),
                ('bow', 'Bow', 'A cute bow to accessorize your look', 'outfits', 'head', 'premium', 1200, '/items/Head/Bow.png', '/items/Head/Bow.svg'),
                ('toga', 'Toga', 'A majestic toga headpiece', 'outfits', 'head', 'rare', 1800, '/items/Head/Toga.png', '/items/Head/Toga.svg'),
                ('clownnose', 'Clown Nose', 'A fun and playful red clown nose', 'outfits', 'nose', 'premium', 1000, '/items/Nose/ClownNose.png', '/items/Nose/ClownNose.svg'),
                ...
                ('dodo', 'Dodo', 'A rare dodo bird that waddles alongside you', 'outfits', 'minipet', 'event_rare', 2200, '/Mini pets/Dodo/1.svg', '/Mini pets/Dodo/1.svg'),
                ('donkey', 'Donkey', 'A friendly donkey that trots beside you', 'outfits', 'minipet', 'normal', 1000, '/Mini pets/Donkey/1.svg', '/Mini pets/Donkey/1.svg'),
                ...
                ('octopus', 'Octopus', 'A clever octopus that floats beside you', 'outfits', 'minipet', 'rare', 1700, '/Mini pets/Octopus/1.svg', '/Mini pets/Octopus/1.svg'),
                ...
                ('pig', 'Pig', 'A cheerful pig that bounces along with you', 'outfits', 'minipet', 'normal', 900, '/Mini pets/Pig/1.svg', '/Mini pets/Pig/1.svg'),
                ('polar_bear', 'Polar Bear', 'A cuddly polar bear that waddles beside you', 'outfits', 'minipet', 'rare', 2000, '/Mini pets/Polar Bear/1.svg', '/Mini pets/Polar Bear/1.svg'),
                ...
                ('red_parrot', 'Red Parrot', 'A loyal red parrot companion that follows you around', 'outfits', 'minipet', 'rare', 1500, '/Mini pets/Red Parrot/1.svg', '/Mini pets/Red Parrot/1.svg'),
                ...
                ('turkey', 'Turkey', 'A proud turkey that struts beside you', 'outfits', 'minipet', 'normal', 1100, '/Mini pets/Turkey/1.svg', '/Mini pets/Turkey/1.svg'),
                ('turtle', 'Turtle', 'A steady turtle that follows in your footsteps', 'outfits', 'minipet', 'normal', 1000, '/Mini pets/Turtle/1.svg', '/Mini pets/Turtle/1.svg'),
                ...
                ('zombie_bird', 'Zombie Bird', 'An undead bird that haunts your path', 'outfits', 'minipet', 'event_rare', 2400, '/Mini pets/Zombie Bird/1.svg', '/Mini pets/Zombie Bird/1.svg'),
                ...
                ('team_skin', 'Team Skin', 'Show your team spirit!', 'outfits', 'skin', 'rare', 0, '/items/skin/team_skin.png', '/items/team_skin.svg')
